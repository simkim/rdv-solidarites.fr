...
class Admin::RdvCollectifWizardStepsController < AgentAuthController
  before_action :set_agent

  PERMITTED_PARAMS = [
    :motif_id, :duration_in_min, :starts_at, :lieu_id, :context, :service_id,
    :organisation_id, :ignore_benign_errors, :max_participants_count,
  ...
  def rdv_wizard_for(request_params)
    klass = "Admin::RdvCollectifWizardForm::#{current_step.camelize}".constantize
