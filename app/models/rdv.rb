...
class Rdv < ApplicationRecord
  ...
  # Delegates
  delegate :home?, :phone?, :public_office?, :reservable_online?, :service_social?, :follow_up?, :service, :collective?, to: :motif

  # Validations
  validates :starts_at, :ends_at, :agents, presence: true
  validates :rdvs_users, presence: true, unless: :collective?
